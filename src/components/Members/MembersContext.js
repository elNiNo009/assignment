...
function MemberContextProvider(props) {
  ...
  const fetchMembersHandler = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/memberRecord/" + props.companyId
      );
  ...
  async function addMemberHandler(member) {
    const response = await fetch("http://localhost:3000/companymemberAdd", {
      method: "POST",
  ...
  async function deleteMemberHandler(id) {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/companyMemberDelete/" + id,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  async function editMemberHandler(id, updatedMember) {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/companyMemberEdit/" + id,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
